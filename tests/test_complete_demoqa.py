...
def test_complete_demoqa():
    ...
    browser.element('#userEmail').type('danila@mail.com')
    ...
    browser.element('#uploadPicture').send_keys(os.path.abspath('picture/image.jpg'))
    ...
    browser.element('.modal-body').should(have.text('08 August,2002'))
    browser.element('.modal-body').should(have.text('Economics'))
